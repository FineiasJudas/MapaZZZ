...
3.6. Mediante notificação da Salōnis, o Utilizador fica responsável por actualizar a App MapaZZZ, por meio das lojas oficiais da Google, da Huawei e da Apple (Play Store, Gallery e App Stores, respectivamente).{'\n'}
3.7. A Salōnis não se responsabiliza por qualquer tentativa de utilização da aplicação por um equipamento incompatível ou que não permita a sua correta segurança e execução.{'\n'}
...
3.11. Em caso de perda do dispositivo móvel com a app instalada, suspeita de acções fraudulentas, tentativas de manipulação ou acesso não autorizado à sua conta (para utilizadores registados), o Utilizador deverá informar a Salōnis através dos contactos fornecidos para que as medidas adequadas possam ser tomadas.{'\n'}
3.12. A Salōnis reserva-se o direito de incluir informações sobre o projecto e possíveis formas de apoio dentro da Aplicação, dada a sua natureza não lucrativa.{'\n'}{'\n'}

4. SEGURANÇA E RESPONSABILIDADE{'\n'}
4.1. A App MapaZZZ implementa medidas de segurança razoáveis para proteger os dados dos utilizadores, garantindo a confidencialidade e integridade das informações, seguindo as melhores práticas da indústria. A Salōnis compromete-se a garantir a segurança da informação e a protecção dos dados pessoais dos Utilizadores, em conformidade com a Lei n.º 22/11, de 17 de Junho, e demais legislação aplicável.{'\n'}
4.2. A Salōnis envidará os melhores esforços para garantir a disponibilidade e o correcto funcionamento da Aplicação, mas não garante a sua operação ininterrupta ou isenta de erros.{'\n'}
4.3. A Salōnis não se responsabiliza pela utilização indevida da Aplicação por parte do Utilizador, incluindo o reporte de informações falsas ou enganosas.{'\n'}
4.4. A Salōnis não responderá por quaisquer danos sofridos pelo Utilizador em consequência do não cumprimento das obrigações decorrentes destes Termos ou por falhas de internet, do dispositivo móvel ou de outros factores externos ao controlo da Salōnis.{'\n'}
4.5. O Utilizador é o único responsável pelo conteúdo das fotografias e informações que reporta através da Aplicação. A Salōnis utiliza IA para auxiliar na análise, mas não garante a veracidade de todo o conteúdo reportado pelos utilizadores.{'\n'}{'\n'}

5. CANCELAMENTO E SUSPENSÃO{'\n'}
5.1. Utilizadores Registados: O Utilizador poderá, a qualquer momento, solicitar o cancelamento da sua conta na App MapaZZZ através das opções disponíveis na Aplicação ou entrando em contacto com a Salōnis.{'\n'}
5.2. A Salōnis reserva-se o direito de suspender ou cancelar o acesso de um Utilizador à Aplicação, temporária ou permanentemente, em caso de violação destes Termos, uso indevido da Aplicação ou por outras razões justificadas, sem necessidade de aviso prévio.{'\n'}{'\n'}
...
7.4. A Salōnis é responsável pelo tratamento dos dados pessoais, conforme a Política de Privacidade e a legislação aplicável.{'\n'}{'\n'}

8. ACTUALIZAÇÕES{'\n'}
8.1. Os presentes Termos e Condições podem ser alterados unilateralmente pela Salōnis sempre que se mostre necessário, seja por motivos legais, técnicos ou de melhoria da Aplicação.{'\n'}
...
9. SUPORTE{'\n'}
9.1. Em caso de dúvidas, problemas ou necessidade de suporte técnico relacionado com a App MapaZZZ, o Utilizador poderá entrar em contacto com a Salōnis através do seguinte endereço de correio eletrónico: [Inserir Endereço de Email de Suporte].{'\n'}
9.2. A Salōnis envidará os melhores esforços para responder às questões e fornecer suporte de forma atempada.{'\n'}{'\n'}
