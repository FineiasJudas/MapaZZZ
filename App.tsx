  ...
  useEffect(() => {
    ...
    const unsubscribe = NetInfo.addEventListener((state) => {
      ...
      if (
        ...
        isNowConnected !== previousConnectionStatus
      ) {
        if (!isNowConnected) {
          Toast.show({
            type: "error",
      ...
      <AlertProvider>
        <NavigationContainer>
          <Stack.Navigator initialRouteName="WelcomePage">
            ...
            />
            <Stack.Screen
              name="OutbreakPredictorPage"
              component={OutbreakPredictorPage}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="nearHospitalPage"
              component={nearHospitalPage}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="configPage"
...
const styles = StyleSheet.create({
  ...
  text: {
    fontFamily: "Poppins-Regular", // Fonte personalizada
    fontSize: 18,
  },
});
